...
class TestPartLinker(unittest.TestCase):
    def test_part_linker_01(self):
        self.assertEqual(
            ...
            [
                Part(part="pinnule", type="leaf_part", start=0, end=8),
                Count(
                    low=31,
                    start=15,
                    end=23,
    ...
    def test_part_linker_02(self):
        self.assertEqual(
            ...
            [
                ...
                Part(part="trunk", type="plant_part", start=80, end=85),
            ],
        )
    ...
    def test_part_linker_05(self):
        self.assertEqual(
            ...
            [
                Part(end=15, part="leaf", start=9, type="leaf_part"),
                Duration(
                    duration="persistent",
                    part="leaf",
                    end=26,
    ...
    def test_part_linker_06(self):
        self.assertEqual(
            ...
            [
                ...
                Part(part="leaf", type="leaf_part", start=56, end=62),
            ],
        )
